...
class Rectangle:
    ...
    def height(self, value):
        ...
        Raises:
            TypeError: if height is not an int and if height is less than 0
        """
    ...
    def width(self, value):
        ...
        Args:
            value (int): width
        Raises:
            TypeError: if width is not an int and if width is less than 0
        """
        if type(value) is not int:
    ...
    def square(cls, size=0):
        """makes a new instance of Rectangle with width == height == size
        Args:
            size (int): dimension of rectangle with all equal sides (square)
        Returns:
